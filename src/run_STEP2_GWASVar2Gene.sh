...
# 'gencode.v26.annotation.gtf' can be downloaded from: https://www.gtexportal.org/home/datasets

python -u GWASVar2Gene.py --GWAS_variants ../output/out_GWAS_variant_IDs_added.tsv \
        	           ...
        	           -primary_plink_prefix GTEx \
                           ...
                           -plink_memory_allocation 16384 # For 1000 GWAS variants:
